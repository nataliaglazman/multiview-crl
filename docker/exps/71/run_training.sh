...
STEPS=${STEPS:-100000}
TAG=${TAG:-ablation-baseline-levels-style-dropout-05-05-05-synthetic}
...
python ${REPO}/training/main_multimodal.py \
    ...
    --encoder-type vqvae \
    --vqvae-nb-levels 3 \
    --vqvae-hidden-channels 8 \
    --vqvae-embed-dim 8 \
    --vqvae-nb-entries 48 24 12 \
