...
STEPS=${STEPS:-100000}
RES=${RES:-64}
TAG=${TAG:-synthetic-baseline-psuedo-mri-actual-high-res-change-patch-learned-split-detach-style-vq}
...
python ${REPO}/training/main_multimodal.py \
    ...
    --vq-commitment-weight 2 \
    --content-style-levels 0 1 2 \
    --content-dim 16 \
    --total-dim 32 \
    --mask-mode learned_split \
    --separate-encoders \
    --pass-full-to-next-level \
    --contrastive-loss-type infonce \
    --cross-view-negs-only \
    --scale-contrastive-loss 7.0 \
    ...
    --batch-size 16 \
    --train-steps ${STEPS} \
    --content-ratios 0.875 0.625 0.375 \
    --detach-style-injection \
    --use-amp \
    --recon-loss-start-step 1000 \
    --workers 4
