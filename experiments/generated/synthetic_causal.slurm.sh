...
#SBATCH --job-name=synthetic-causal-clean-content-2-scaling-independent-baseline
#SBATCH --output=/scratch/users/%u/%j.out
#SBATCH --error=synthetic-causal-clean-content-2-scaling-independent-baseline-%j.err
...
"$PYTHON" -m training.main_multimodal \
    ...
    --synthetic-res 64 \
    --model-id synthetic-causal-clean-content-2-scaling-independent-baseline \
    --tau 0.1 \
    --total-dim 512 \
    --train-steps 200000 \
    --use-amp \
